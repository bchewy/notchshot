...
- The website retains its verified 0.5.2 app/source downloads while 0.6.0 signing and final installed-build verification remain pending. Its links, version label, local assets, and layout were checked in a browser before merging source changes.
