...
Tools. Download **0.8.1** from
[GitHub Releases](https://github.com/bchewy/notchshot/releases/tag/v0.8.1);
0.7.0 and later keep themselves up to date. It targets Apple silicon and
is not notarized. See the [release notes](docs/releases/0.8.1.md) for changes and
verification limits.
