...
Tools. Download **0.8.2** from
[GitHub Releases](https://github.com/bchewy/notchshot/releases/tag/v0.8.2), open
the disk image, and drag NotchShot into Applications;
0.7.0 and later keep themselves up to date. It targets Apple silicon and
is not notarized. See the [release notes](docs/releases/0.8.2.md) for changes and
verification limits.
...
The current suite has **454 tests**, covering the capture entry path, capture
